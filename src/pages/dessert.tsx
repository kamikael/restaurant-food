...
const dishes: Dish[] = [
  {
    id: "68",
    name: "Ananas au miel et Cognac ",
    description: "Ananas frais caramélisé au miel, flambé au Cognac",
    price: 3,
      ...
      <div className="relative bg-gradient-to-b from-[#0a1a05] via-[#020701] to-[#0a1a05] text-white py-40 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto text-white/90">
            explosion de saveur pour faire revivre vos papilles
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="text-center mb-8">
          <p className="text-gray-600">
            ...
            Dessert{filteredDishes.length > 1 ? "s" : ""} disponible
